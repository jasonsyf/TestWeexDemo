package com.lljjcoder.weiui.library;
...
import com.lljjcoder.weiui.library.city.utils;
...
public class CityPickerView implements CanShow, OnWheelChangedListener {
    ...
    public void initProvinceDatas(Context context) {
        ...
        mProvinceBeanArrayList = new Gson().fromJson(cityJson, new TypeToken<ArrayList<ProvinceBean>>() {
        }.getType());
