package cn.syf.testweexdemo.wxcache;
 ...
 */
public class CacheWXSDKInstance extends WXSDKInstance {
    ...
    public CacheWXSDKInstance(Context context) {
        super(context);
    }

    public CacheWXSDKInstance(Context context, boolean isEnableJSCache) {
        super(context);
        this.isEnableJSCache = isEnableJSCache;
    }
    ...
    public void renderByUrl(String pageName, String url, Map<String, Object> options, String jsonInitData, WXRenderStrategy flag) {
        ...
        //获取本地JS bundle的路径,有缓存则渲染本地，否则直接渲染服务端js;
